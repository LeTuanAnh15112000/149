      ...
      <div class="inner">
        <div class="box_contact_wrap">
          <div class="box_contact_block js_effect">
            ...
            <p class="box_contact_time">お電話でのお問い合わせ：10:00～ 18:30 <br class="box_sp">（水曜定休）</p>
            <p class="btn_primary center white">
              <a href="no_link"><span>CONTACT</span></a>
            </p>
          </div>
        </div>
      </div>
    </section>
    <section class="box_instagram">
      <h3 class="h_title js_effect"><span>Instagram</span></h3>
      <div class="box_instagram_group js_effect">
        <h4 class="box_instagram_ttl"><span><img src="<?php echo TMP_URL ?>/images/footer/icon_instagram.png" width="27" alt="weddiurlmaria"></span>weddiurlmaria</h4>
        ...
        <div class="box_instagram_animation"></div>
      </div>
      <div class="box_instagram_group js_effect">
        ...
        <div class="box_info_block">
          <div class="box_info_detail">
            ...
            <div class="f_info">
              ...
              <p>完全予約制：10:00～18:30<br class="box_sp">（最終受付／16:00）</p>
            </div>
          </div>
          <div class="box_info_nav">
            <ul class="box_info_link">
              ...
              <li><a href="no_link">ヘアメイク</a></li>
            </ul>
            <ul class="box_info_link">
              <li><a href="no_link">卒業式・成人式</a></li>
              <li><a href="no_link">コレクション</a></li>
              <li><a href="no_link">お知らせ</a></li>
              <li><a href="no_link">お問い合わせ</a></li>
            </ul>
          </div>
        </div>
        <div class="box_info_instagram">
          <a href="https://www.instagram.com/weddiurlmaria/" target="_blank" rel="noopener noreferrer"><img src="<?php echo TMP_URL ?>/images/footer/icon_instagram_small.png" width="20" alt="weddiurlmaria"><span>weddiurlmaria</span></a>
          <a href="https://www.instagram.com/weddiurlmaria_hairmake/" target="_blank" rel="noopener noreferrer"><img src="<?php echo TMP_URL ?>/images/footer/icon_instagram_small.png" width="20" alt="weddiurlmaria_hairmake"><span>weddiurlmaria_hairmake</span></a>
        </div>
        <address>&copy; 2024 WEDDIURL MARIA Co., Ltd</address>
      </div>
    </div>
  </footer>
<?php wp_footer(); ?>
